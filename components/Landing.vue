    ...
    >
      <div class="absolute md:left-24 left-6 z-4 flex flex-col">
        ...
        <div class="flex flex-col md:flex-row justify-between">
          <p
            class="hidden md:block text-style-4 leading-[1.525] font-light italic w-4/5 md:w-1/4"
          >
      ...
      <div>
        <h3
          class="font-thin text-style-bigger text-c-4 tracking-tagline ml-6 md:ml-24 mb-6"
        >
          CHI SONO
        </h3>
        <div class="flex flex-col-reverse md:flex-row justify-between">
          <div class="mx-6 md:ml-24 mb-6 ml-6 md:w-1/2">
            ...
            >
              ...
              <p>
                Il mio approccio si basa sull'unione del sapere scientifico e
                delle tecniche osteopatiche, con l'ascolto attento e la
      ...
      >
        <div class="mt-12 md:mt-0">
          <h4
            class="text-center text-style-big text-c-1 leading-[1.525] font-medium mx-6 md:mx-0"
          >
      ...
      <div
        class="sm:mx-12 lg:mx-24 bg-c-1 md:rounded-2xl flex flex-col gap-6 sm:gap-0 xs:gap-0 sm:flex-row xs:flex-row p-6 md:p-12 items-center xs:items-start sm:items-start justify-between w-[-webkit-fill-available] banner-low -translate-y-24 font-thin leading-[1.525] text-style-4 text-center text-pretty"
      >
        <div class="flex items-center flex-col md:gap-8 gap-4 w-fit">
          ...
          />
          <p class="w-full xs:w-28 sm:w-2/3 text-pretty text-style-3">
        ...
        <div class="flex items-center flex-col md:gap-8 gap-4 w-fit">
          <img
            ...
            alt="patologie e disturbi osteopatici"
          />
          <p class="w-full xs:w-24 sm:w-2/3 text-pretty text-style-3">
        ...
        <div class="flex items-center flex-col md:gap-8 gap-4 w-fit">
          ...
          />
          <p class="w-full xs:w-24 sm:w-2/3 text-pretty text-style-3">
            Infortuni sportivi traumatici
          </p>
        </div>
      </div>
    </div>
  </div>
  <footer class="mx-4 sm:mx-12 lg:mx-24">
    <div class="flex justify-between">
      ...
      <img
        src="../assets/roi.png"
        class="h-12 md:h-24 lg:h-auto"
        alt="Registro Osteopati Italiani"
      />
    </div>
    ...
    >
      ...
      <a
        href="https://www.google.it/maps/place/Via+Roma,+5,+11027+Saint-Vincent+AO/@45.7511655,7.6471008,17z/data=!3m1!4b1!4m6!3m5!1s0x4788c6e4947674fd:0x4c21585f8501168!8m2!3d45.7511618!4d7.6496757!16s%2Fg%2F11c25y9_l6?entry=ttu&g_ep=EgoyMDI1MDIwNS4xIKXMDSoASAFQAw%3D%3D"
        target="_blank"
        class="flex items-center gap-4"
      >
    ...
    <div class="bg-c-2 rounded-t-3xl flex items-center justify-center">
      <span
        ...
        >Claudia Oderio Osteopata | Partita IVA: 00649480076 | 
        <a class="md:hidden" href="/informativa-privacy.pdf" download="Informativa Privacy">Informativa Privcy</a>
        <a class="hidden md:block" href="/privacy">Privacy Policy</a>
         | Sito web a cura di <a href="https://mcwdesign.it" target="_blank">MCW Design</a></span
      >
    </div>
  </footer>
</template>
