<template>
  <div class="hero-container">
    <div>
      <img
        class="md:ml-24 ml-12 w-[75vw] sm:h-[20vh] lg:h-[25vh] top-12 md:top-1/4 absolute transform md:-translate-y-1/2 md:left-0 z-10"
    ...
    >
      <h1
        class="z-5 text-style-big leading-[110%] md:leading-relaxed text-center font-[300] center p-6 md:p-0 md:w-[55%]"
      >
        "<span class="italic"
